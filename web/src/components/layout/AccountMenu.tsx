  ...
  return (
    <div className="relative shrink-0" ref={wrapRef}>
      <button
        ...
        aria-haspopup="menu"
        className={cn(
          "flex h-10 max-w-[min(46vw,220px)] items-center gap-2 rounded-[var(--keyra-radius-pill)] border border-keyra-border px-3 text-left text-[13px] font-semibold text-keyra-primary transition hover:border-[rgba(102,227,255,0.45)] sm:max-w-[260px] sm:px-4 sm:text-sm",
        )}
        onClick={(e) => {
          e.stopPropagation();
          setOpen((o) => !o);
