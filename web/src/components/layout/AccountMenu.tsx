  ...
  return (
    <div className="relative shrink-0" ref={wrapRef}>
      <button
        ...
        aria-haspopup="menu"
        className={cn(
          "flex h-10 items-center rounded-[var(--keyra-radius-pill)] border border-keyra-border text-left text-[13px] font-medium text-keyra-primary transition-colors duration-150 ease-out active:border-[rgba(255,255,255,0.18)] hover:border-[rgba(255,255,255,0.14)]",
