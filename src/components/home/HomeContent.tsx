...
function SectionShell({
  ...
  return (
    <section
      id={id}
      className={`scroll-mt-28 px-4 py-24 sm:px-6 sm:py-32 ${className}`}
    >
...
export function HomeContent() {
  return (
    <>
      <section className="relative min-h-[92vh] scroll-mt-28 overflow-hidden border-b border-kerya-border bg-kerya-bg px-4 py-24 sm:px-6 sm:py-32">
        <div
