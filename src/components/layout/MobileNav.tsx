        ...
        {open ? (
          <>
            <motion.div
              ...
              className="fixed inset-x-0 bottom-0 top-44 z-[250] bg-black/40 backdrop-blur-[1px] lg:hidden"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            <motion.nav
              ...
              id="mobile-nav-panel"
              className="fixed left-0 right-0 top-44 z-[260] max-h-[min(75dvh,calc(100dvh-11rem))] overflow-y-auto border-b border-keyra-border bg-keyra-bg/98 px-4 py-4 shadow-lg backdrop-blur-md lg:hidden"
