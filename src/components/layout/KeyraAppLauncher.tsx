      ...
      {open ? (
        ...
        >
          ...
          <div className="keyra-app-launcher-scroll-wrap">
            <ul
              className="keyra-app-launcher-scroll grid max-h-[min(28rem,calc(100vh-9rem))] grid-cols-2 gap-2 overflow-y-auto overscroll-y-contain py-0.5 pl-1 pr-1.5 sm:grid-cols-3"
